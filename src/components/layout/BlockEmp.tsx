    ...
    <div>
      ...
      <div>
        <div className="flex flex-col sm:flex-row sm:justify-between items-start sm:items-center text-green my-4">
          <h2 className="text-2xl font-medium">Persona Residence</h2>
        ...
        <p className="text-white">73,55m² e 63,15m²</p>
        <div className="flex items-center text-white mt-4">
          <GoLocation size={22} />
          <span className="ml-2">São José do Rio Preto - São Paulo</span>
        </div>
      </div>
    </div>
  );
